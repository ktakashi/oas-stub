...
class OasStubRoutes(private val routes: HttpServerRoutes,
    ...
    fun get(path: String, handler: OasStubRouteHandler) = routes.get(path, adjustHandler(handler))
    fun post(path: String, handler: OasStubRouteHandler) = routes.post(path, adjustHandler(handler))
    fun put(path: String, handler: OasStubRouteHandler) = routes.put(path, adjustHandler(handler))
    fun delete(path: String, handler: OasStubRouteHandler) = routes.delete(path, adjustHandler(handler))
