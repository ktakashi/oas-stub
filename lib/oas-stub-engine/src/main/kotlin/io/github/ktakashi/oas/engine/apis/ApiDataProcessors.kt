...
interface ApiDataValidator: MediaSupport, OpenApiVersionSupport {
...
abstract class AbstractApiDataValidator(version: SpecVersion): ApiDataProcessor(version), ApiDataValidator
