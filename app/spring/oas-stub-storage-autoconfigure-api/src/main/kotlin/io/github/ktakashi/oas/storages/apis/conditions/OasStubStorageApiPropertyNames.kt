 ...
 *
 * This *should not* be used custom auto-configuration.
 */
...
/**
 * In-memory session storage auto-configuration module name
 *
 * Make this module to be loaded *after* your auto-configure module
 * ```kotlin
 * @AutoConfiguration(
...
/**
 * In-memory persistent storage auto-configuration module name
 *
 * Make this module to be loaded *after* your auto-configure module
 * ```kotlin
 * @AutoConfiguration(
