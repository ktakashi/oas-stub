...
class OasServerApplicationTest(@Autowired private val oasStubTestService: OasStubTestService,
    ...
    class TestSecurityConfig {
        @Bean
        fun sslContextFactorySupplier(certificate: Pair<PrivateKey, X509Certificate>) = makeTestKeyStore(Triple("key", certificate.first, certificate.second), "password").let { ks ->
            OasStubServerConnectorConfiguration.SslContextFactorySupplier {
