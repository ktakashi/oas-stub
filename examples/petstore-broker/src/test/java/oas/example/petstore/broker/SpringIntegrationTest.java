...
@ConfigurationParameter(key = Constants.GLUE_PROPERTY_NAME, value = "oas.example.petstore.broker.cucumber.glue.base,oas.example.petstore.broker.cucumber.glue.spring")
